...
NDefines_Graphics.NGraphics.GRADIENT_BORDERS_THICKNESS_RESISTANCE = 1.0
NDefines_Graphics.NGraphics.GRADIENT_BORDERS_THICKNESS_INTEL_LEDGER = 1.0
NDefines_Graphics.NGraphics.GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_A = 1.0
NDefines_Graphics.NGraphics.GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_B = 1.0
...
NDefines_Graphics.NGraphics.BORDER_WIDTH = .5
...
NDefines_Graphics.NGraphics.DRAW_FOW_CUTOFF = 208
